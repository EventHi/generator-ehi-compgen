...
module.exports = Generator.extend({
  prompting: function () {
    ...
    this.log(yosay(
      'Welcome to the transcendent ' + chalk.red('generator-ehi') + ' generator!'
    ));
  ...
  writing: function () {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(`${this.props.compName}/${this.props.compName}.css`),
      {componentName: this.props.compName}
    );
    this.fs.copyTpl(
      this.templatePath('theWork.css'),
      this.destinationPath(`${this.props.compName}/theWork.css`),
      {componentName: this.props.compName}
    );
  }
});
